...
public class Money : ValueObject
{
    ...
    {
        if (!Enum.TryParse(currency, true, out Currency parsed))
        {
            throw new InvalidOperationException($"Unsupported currency code '{currency.ToUpper()}'");
        }
    ...
    public static Money operator *(Money m, uint ui)
    {
        return new Money(m.Amount * ui, m.Currency);
    }
}
